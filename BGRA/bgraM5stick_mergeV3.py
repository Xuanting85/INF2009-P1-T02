...
spike_threshold_d1_acc = 2.775
spike_threshold_d1_gyro = 2.8
spike_threshold_d2_acc = 2.775
spike_threshold_d2_gyro = 2.8
...
def check_for_sudden_movement(new_angle, threshold=2):
...
canvas_widget_matplotlib = canvas_matplotlib.get_tk_widget()
canvas_widget_matplotlib.pack(side=tk.TOP, fill=tk.BOTH, expand=True)

# Create a Tkinter canvas for the video feed
canvas_video_feed = tk.Canvas(root, width=640, height=360)
canvas_video_feed.pack(side=tk.TOP)
...
# Create Entry widgets for spike thresholds
threshold_entry_d1_acc = tk.Entry(root)
threshold_entry_d1_gyro = tk.Entry(root)
threshold_entry_d2_acc = tk.Entry(root)
threshold_entry_d2_gyro = tk.Entry(root)

# Create labels for the spike thresholds
label_d1_acc = tk.Label(root, text="Device 1 - Accel Spike Threshold:")
label_d1_gyro = tk.Label(root, text="Device 1 - Gyro Spike Threshold:")
label_d2_acc = tk.Label(root, text="Device 2 - Accel Spike Threshold:")
label_d2_gyro = tk.Label(root, text="Device 2 - Gyro Spike Threshold:")

# Pack labels and entry boxes for the spike thresholds
label_d1_acc.pack(-160, 60, side=tk.BOTTOM)
threshold_entry_d1_acc.pack(-160, 20, side=tk.BOTTOM)
label_d1_gyro.pack(-80, 60, side=tk.BOTTOM)
threshold_entry_d1_gyro.pack(-80, 20, side=tk.BOTTOM)
label_d2_acc.pack(80, 60, side=tk.BOTTOM)
threshold_entry_d2_acc.pack(80, 20, side=tk.BOTTOM)
label_d2_gyro.pack(160, 60, side=tk.BOTTOM)
threshold_entry_d2_gyro.pack(160, 20, side=tk.BOTTOM)

def update_thresholds():
    global spike_threshold_d1_acc, spike_threshold_d1_gyro, spike_threshold_d2_acc, spike_threshold_d2_gyro
    spike_threshold_d1_acc = float(threshold_entry_d1_acc.get())
    spike_threshold_d1_gyro = float(threshold_entry_d1_gyro.get())
    spike_threshold_d2_acc = float(threshold_entry_d2_acc.get())
    spike_threshold_d2_gyro = float(threshold_entry_d2_gyro.get())

# Button to update thresholds
update_button = tk.Button(root, text="Update Thresholds", command=update_thresholds)
update_button.pack()
...
def update_video_feed():
    ...
    canvas_video_feed.create_image(0, 0, image=photo, anchor=tk.SW)
    canvas_video_feed.image = photo
    root.after(1000, update_video_feed)  # Update every 300 milliseconds
